...
public class MergeSort {
  ...
  public static void merge(int[] array, int[] temp, int leftStart, int rightEnd) {
    /*
     * initialize leftEnd to midway between leftStart and rightEnd, rightStart to one index after
     * leftEnd
     */
    ...
    /*
     * if left or right is still less than the length of the array segment place all remaining
     * values of the array segments into the array
     */
